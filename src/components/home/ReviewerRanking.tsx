...
export default function ReviewerRanking() {
  return (
    <div className="mx-[2rem] mt-[3rem] flex max-w-[35rem] shrink-0 flex-col gap-[2rem] overflow-x-scroll whitespace-nowrap scrollbar-hide md:ml-[2.5rem] md:mt-[4rem] md:max-w-[53rem] lg:m-0 lg:mt-[4.5rem] lg:w-[25rem] lg:gap-[3rem] lg:border-l lg:border-black-bg lg:px-[3rem]">
